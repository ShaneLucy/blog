...
<article class="trip-card">
	...
	<div class="trip-card__body">
		...
		<div class="trip-card__meta">
			<span class="trip-card__destination">
				...
				<svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 16 16">
					<path
						d="M8 1.5a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9zm0 10.5c-3.5 0-6 1.5-6 2.5h12c0-1-2.5-2.5-6-2.5z"
						fill="currentColor"
					/>
				</svg>
				Marrakech, Morocco
		...
		<p class="trip-card__excerpt">
			Two weeks wandering the labyrinthine medinas, trekking the High Atlas, and watching the Sahara
			sun blaze orange over the dunes at Erg Chebbi.
		</p>
	</div>
</article>
```
...
<button class="tag-pill tag-pill--interactive" type="button" role="checkbox" aria-checked="false">
	Desert
</button>

<!-- Active/selected state — aria-checked="true" is set by Svelte -->
<button class="tag-pill tag-pill--interactive" type="button" role="checkbox" aria-checked="true">
	Culture
</button>
```
