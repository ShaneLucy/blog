...
:root {
  ...
  --color-bg-muted:        oklch(92% 0.010 80);      /* slightly deeper for card hover */
  --color-surface:         oklch(100% 0 0);           /* pure white for cards */
  --color-surface-raised:  oklch(99% 0.003 80);      /* elevated card surface */

  /* Text */
  --color-text-primary:    oklch(22% 0.010 60);      /* ~#2D2D2D near-black */
  --color-text-secondary:  oklch(46% 0.012 60);      /* mid-tone for metadata */
  --color-text-tertiary:   oklch(62% 0.010 60);      /* placeholder, captions */
  --color-text-inverse:    oklch(98% 0.005 80);      /* text on dark backgrounds */

  /* Accent — Terracotta (primary) */
  --color-accent:          oklch(58% 0.130 42);      /* ~#C4703F terracotta */
  --color-accent-subtle:   oklch(94% 0.025 42);      /* tinted background */
  --color-accent-hover:    oklch(52% 0.130 42);      /* darker on hover */
  --color-accent-active:   oklch(46% 0.130 42);      /* pressed state */

  /* Accent — Deep Teal (secondary, for variety) */
  --color-teal:            oklch(44% 0.080 195);     /* ~#2A6F6F deep teal */
  --color-teal-subtle:     oklch(94% 0.020 195);
  --color-teal-hover:      oklch(38% 0.080 195);

  /* Borders & dividers */
  --color-border:          oklch(89% 0.010 80);      /* subtle dividers */
  --color-border-strong:   oklch(78% 0.015 80);      /* visible borders */
  --color-border-focus:    oklch(58% 0.130 42);      /* focus ring — matches accent */

  /* Semantic states */
  --color-error:           oklch(52% 0.180 25);
  --color-success:         oklch(52% 0.130 155);

  /* Overlays */
  --color-overlay:         oklch(10% 0 0 / 0.85);    /* lightbox backdrop */
  --color-overlay-light:   oklch(10% 0 0 / 0.40);    /* hero image scrim */
  ...
  @media (prefers-color-scheme: dark) {
    ...
    --color-bg-subtle:       oklch(18% 0.010 60);
    --color-bg-muted:        oklch(22% 0.010 60);
    --color-surface:         oklch(18% 0.010 60);
    --color-surface-raised:  oklch(22% 0.012 60);

    --color-text-primary:    oklch(94% 0.008 80);
    --color-text-secondary:  oklch(72% 0.010 80);
    --color-text-tertiary:   oklch(56% 0.008 80);
    --color-text-inverse:    oklch(14% 0.008 60);

    --color-accent:          oklch(68% 0.130 42);    /* slightly lighter for dark bg */
    --color-accent-subtle:   oklch(22% 0.040 42);
    --color-accent-hover:    oklch(74% 0.130 42);
    --color-accent-active:   oklch(78% 0.130 42);

    --color-teal:            oklch(60% 0.080 195);
    --color-teal-subtle:     oklch(20% 0.030 195);
    --color-teal-hover:      oklch(66% 0.080 195);

    --color-border:          oklch(28% 0.012 60);
    --color-border-strong:   oklch(38% 0.015 60);
    --color-border-focus:    oklch(68% 0.130 42);

    --color-overlay:         oklch(5% 0 0 / 0.90);
  ...
  --text-sm:       clamp(0.833rem,  0.80rem  + 0.17vw, 0.9rem);    /* ~13–14.4px */
  --text-base:     clamp(1rem,      0.96rem  + 0.20vw, 1.063rem);  /* ~16–17px */
  ...
  --text-2xl:      clamp(1.602rem,  1.40rem  + 1.01vw, 2.25rem);   /* ~26–36px */
  --text-3xl:      clamp(1.802rem,  1.50rem  + 1.51vw, 3rem);      /* ~29–48px */
  --text-4xl:      clamp(2.027rem,  1.60rem  + 2.14vw, 3.75rem);   /* ~32–60px */
  --text-hero:     clamp(2.5rem,    1.80rem  + 3.50vw, 5rem);      /* ~40–80px */
  ...
  --shadow-lg:  0 8px 24px oklch(10% 0 0 / 0.10), 0 3px 8px oklch(10% 0 0 / 0.06);
...
.site-nav__hamburger {
  ...
  cursor: pointer;
  color: var(--color-text-primary);
  transition: var(--transition-color), background-color var(--duration-fast) var(--ease-out);
}
  ...
  <div class="container">
    <div class="site-footer__inner">
      ...
      <p class="site-footer__copy">
        ...
        &copy; <time datetime="2026">2026</time> Wandering Pages.
        All rights reserved.
      </p>
...
<section class="hero hero--landing" aria-label="Introduction">
  ...
  <div class="hero__content container">
    ...
    <p class="hero__tagline">
      Field notes, photographs, and stories from the road.
    </p>
...
.hero__scrim {
  ...
  background: linear-gradient(
    to bottom,
    oklch(10% 0 0 / 0.25) 0%,
    oklch(10% 0 0 / 0.50) 50%,
    oklch(10% 0 0 / 0.70) 100%
  );
}
...
.hero__title {
  ...
  text-shadow: 0 2px 16px oklch(5% 0 0 / 0.40);
}
...
.hero__tagline {
  ...
  max-width:   52ch;
  margin:      0;
  text-shadow: 0 1px 8px oklch(5% 0 0 / 0.30);
}
...
<article class="trip-card">
  ...
  <div class="trip-card__body">
    ...
    <h2 class="trip-card__title">
      ...
      <a href="/travel/morocco-2025" class="trip-card__title-link">
        Sands &amp; Souks: Morocco
      </a>
    </h2>
    ...
    <div class="trip-card__meta">
      <span class="trip-card__destination">
        ...
        <svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 16 16">
          <path d="M8 1.5a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9zm0 10.5c-3.5 0-6 1.5-6 2.5h12c0-1-2.5-2.5-6-2.5z"
                fill="currentColor"/>
        </svg>
        Marrakech, Morocco
      </span>
      <time class="trip-card__date" datetime="2025-03-10/2025-03-24">
        Mar 10 – Mar 24, 2025
      </time>
    </div>

    <p class="trip-card__excerpt">
      Two weeks wandering the labyrinthine medinas, trekking the High Atlas,
      and watching the Sahara sun blaze orange over the dunes at Erg Chebbi.
    </p>
...
<button
  class="tag-pill tag-pill--interactive"
  type="button"
  role="checkbox"
  aria-checked="false"
>
...
<section class="trip-filters" aria-label="Filter trips">
  ...
  <div class="trip-filters__inner container">
    ...
    <div class="trip-filters__group">
      <label class="trip-filters__label" for="filter-destination">
        Destination
      </label>
      <div class="trip-filters__select-wrap">
        ...
        <svg class="trip-filters__chevron" aria-hidden="true" focusable="false"
    ...
    <div
      class="trip-filters__group trip-filters__group--tags"
      role="group"
    ...
    >
      ...
      <div class="trip-filters__tags">
        <button class="tag-pill tag-pill--interactive" type="button"
                role="checkbox" aria-checked="false">Desert</button>
        <button class="tag-pill tag-pill--interactive" type="button"
                role="checkbox" aria-checked="false">Culture</button>
        <button class="tag-pill tag-pill--interactive" type="button"
                role="checkbox" aria-checked="true">Architecture</button>
        <button class="tag-pill tag-pill--interactive" type="button"
                role="checkbox" aria-checked="false">Hiking</button>
        <button class="tag-pill tag-pill--interactive" type="button"
                role="checkbox" aria-checked="false">Food</button>
      </div>
    </div>
...
.trip-filters__select:focus-visible {
  ...
  border-color: var(--color-border-focus);
  box-shadow:   0 0 0 3px oklch(58% 0.130 42 / 0.25);
}
  ...
  <div class="container">
    ...
    <ul class="photo-grid" role="list">
      ...
      <li class="photo-grid__item">
        ...
        <button
          class="photo-grid__trigger"
          type="button"
          aria-label="View photo: Camel caravan at sunset, Erg Chebbi"
          data-index="0"
        >
          <img
...
.trip-card.is-visible {
  ...
  transition:
    opacity    300ms var(--ease-out),
    transform  300ms var(--ease-default),
    /* preserve the hover transitions */
    box-shadow var(--duration-normal) var(--ease-out),
    border-color var(--duration-fast) var(--ease-out);
}
