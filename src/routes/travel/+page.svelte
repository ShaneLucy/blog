...
<svelte:head>
  ...
  <meta name="description" content="A collection of trips — photographs, notes, and stories from the road." />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content={SITE_NAME} />
  <meta property="og:title" content="Travel — Wandering Pages" />
  <meta property="og:description" content="A collection of trips — photographs, notes, and stories from the road." />
...
<div class="travel-page">
  ...
  <div class="container">
    ...
    <section class="travel-page__filters" aria-label="Filter trips">
      <TripFilters destinations={data.destinations} tags={data.tags} bind:selectedDestination bind:selectedTags bind:sortBy />
    </section>
