  ...
  <section class="about-intro section--sm">
    <div class="container container--narrow">
      ...
      <div class="about-intro__body prose">
        <p>
          Wandering Pages started as a way to keep honest notes about the places I visit — not the polished highlight reel, but the real
          texture of a trip. The wrong trains caught and the right ones missed. The little restaurants with no English menu. The view from a
          ridge you almost didn't bother climbing. I travel slowly and try to pay attention.
        </p>
        <p>
          This site is part travel diary, part photography archive. If something here makes you want to book a flight, or just read a little
          more carefully the next time you're somewhere new, that's more than enough for me.
        </p>
      </div>
    </div>
  </section>
      ...
      <ul class="about-pillars" role="list">
        <li class="about-pillar">
          ...
          <p class="about-pillar__body">
            A week in one city beats five cities in a week. I'd rather know the name of a neighbourhood bakery than tick off an itinerary.
            Moving slowly means you notice more — the light at a particular hour, the rhythm of a market, the way people talk to each other
            in the evening.
          </p>
        </li>
        <li class="about-pillar">
          ...
          <p class="about-pillar__body">
            I photograph the things I want to remember, not the things I think other people want to see. That means a lot of ordinary
            details — doorways, food, shadows — alongside the landscapes. The camera is a reason to look carefully, not just a device for
            collecting proof that you were somewhere.
          </p>
        </li>
        <li class="about-pillar">
          <h3 class="about-pillar__title">Finding the unexpected</h3>
          <p class="about-pillar__body">
            The best moments on any trip are almost never the ones in the guidebook. I try to leave enough space in a day for things to go
            sideways in interesting ways. Some of my favourite memories started as wrong turns.
          </p>
        </li>
      </ul>
    </div>
      ...
      <ul class="destinations-list" role="list">
        {#each destinations as dest (dest.slug)}
          <li class="destinations-list__item">
            <a href={resolve(`/travel/${dest.slug}`)} class="destination-card" aria-label="{dest.name}, {dest.year} — {dest.description}">
